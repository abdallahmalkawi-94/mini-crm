        ...
        <form action="{{route('employee.update')}}" method="POST">
            ...
            <div class="form-control">
                <div class="m-2 p-2">
                    ...
                    <input class="form-control" type="text" name="first_name" value="{{old('first_name', $employee->first_name)}}" placeholder="First Name"
                           required>
                </div>

                <div class="m-2 p-2">
                    <label class="form-label">Last Name</label>
                    <input class="form-control" type="text" name="last_name" value="{{old('last_name', $employee->last_name)}}" placeholder="Last Name" required>
                </div>
